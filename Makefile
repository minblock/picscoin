...
ACLOCAL = ${SHELL} /picscoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /picscoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /picscoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /picscoin/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /picscoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /picscoin
abs_srcdir = /picscoin
abs_top_builddir = /picscoin
abs_top_srcdir = /picscoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /picscoin/build-aux/install-sh
