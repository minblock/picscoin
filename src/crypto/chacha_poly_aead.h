// Copyright (c) 2019 The Picscoin Core developers
...
/* A AEAD class for ChaCha20-Poly1305@picscoin.
 *
 ...
 *
 * The chacha20-poly1305@picscoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@picscoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@picscoin are relatively fast in
