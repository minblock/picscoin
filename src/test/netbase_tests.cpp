...
{
    BOOST_CHECK(TestSplitHost("www.picscoins.org", "www.picscoins.org", -1));
    BOOST_CHECK(TestSplitHost("[www.picscoins.org]", "www.picscoins.org", -1));
    BOOST_CHECK(TestSplitHost("www.picscoins.org:80", "www.picscoins.org", 80));
    BOOST_CHECK(TestSplitHost("[www.picscoins.org]:80", "www.picscoins.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:1337", "127.0.0.1", 1337));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:1337", "127.0.0.1", 1337));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:1337", "::ffff:127.0.0.1", 1337));
    BOOST_CHECK(TestSplitHost("[::]:1337", "::", 1337));
    BOOST_CHECK(TestSplitHost("::1337", "::1337", -1));
    BOOST_CHECK(TestSplitHost(":1337", "", 1337));
    BOOST_CHECK(TestSplitHost("[]:1337", "", 1337));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:1337", "127.0.0.1:1337"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:1337", "[::]:1337"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
