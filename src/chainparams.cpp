...
{
    const char* pszTimestamp = "25/Jan/2018 Two ex-Guantanamo Bay detainees transferred to Ghana";
...
public:
	...
	consensus.nPowDGWHeight = 63260;
        ...
        assert(consensus.hashGenesisBlock == uint256S("0xf40e7646b3d251766a184024ebc024035edae584e0694dc875edc9757e267af5"));
        ...
        vSeeds.emplace_back("dnsseed.picscoin.org", true);
        //vSeeds.emplace_back("seed-a.picscoin.loshan.co.uk", true);
        //vSeeds.emplace_back("dnsseed.thrasher.io", true);
        //vSeeds.emplace_back("dnsseed.picscointools.com", true);
        //vSeeds.emplace_back("dnsseed.picscoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 1117992, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x589a007691bf1b7c59136c6bdc423df51002af63ceb81e5578d6d03133c24f3a"));
        assert(genesis.hashMerkleRoot == uint256S("0xdd9921f0ad3a86be19920cfd70c63520dcd994831cb5df30983b5b9de60f575c"));
        ...
        checkpointData = (CCheckpointData) {
            {
                {  0, uint256S("0x589a007691bf1b7c59136c6bdc423df51002af63ceb81e5578d6d03133c24f3a")},
            }
        };
