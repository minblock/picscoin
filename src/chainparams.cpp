...
public:
    CMainParams() {
        ...
        consensus.MinBIP9WarningHeight = 28224; // segwit activation height + miner confirmation window
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x4c, 0x65, 0x65, 0x74};
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet.picsco.in");
