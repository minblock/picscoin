...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("dnsseed.picscoins.org", true);
        ...
        chainTxData = ChainTxData{
            // Data as of block 2a8d3985a745e60ebe09b9ad8e46face1929575fcd610fee77084ac69711bbcd (height 9305).
            1545418532, // * UNIX timestamp of last known number of transactions
            9327,  // * total number of transactions between genesis and that timestamp
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x763e60c05a26fcb7bf95bdb0a0b8c47b5f39d7fdc08f75c8cad862e870f15047"); //343833
        ...
        chainTxData = ChainTxData{
            // Data as of block 1cef4a5283b4e4848cb85ad719312e50f7b63eebbce6627b53db498196fe302e (height 0)
            1486949366,
            1268525,
            0.01
        };
