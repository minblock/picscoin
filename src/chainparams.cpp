...
public:
    CMainParams() {
        ...
        consensus.CSVHeight = 20160; // 53e0af7626f7f51ce9f3b6cfc36508a5b1d2f6c4a75ac215dc079442692a4c0b
        consensus.SegwitHeight = 20160; // 0000000000000000001c8018d9cb3b742ef25114f27563e3fc4a1902167f9893
        consensus.MinBIP9WarningHeight = 141833; // segwit activation height + miner confirmation window
        ...
        m_assumed_blockchain_size = 0.2330;
        m_assumed_chain_state_size = 0.0370;
        ...
        checkpointData = {
            {
               ...
               {  58462, uint256S("0x24d1c756941d3ff0766742a711241708150b43af47e36bdced07f33dbbb3e5ba")},
               {  60032, uint256S("0x9dff60cbdf4c9c6e59b594d6b7d7fb6ad9055bc23c50cbae3bee8b81691b853c")},
...
public:
    CTestNetParams() {
        ...
        // Deployment of Taproot (BIPs 340-342)
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].bit = 2;
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nStartTime = 1641013200; // 	Sat Jan 01 2022
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nTimeout = 1672549200; // Sun Jan 01 2023
