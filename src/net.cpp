...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Picscoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"picscointools.com", "dnsseed.picscointools.com"},
    {"picscoinpool.org", "dnsseed.picscoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"picscointools.com", "testnet-seed.picscointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Picscoin is probably already running."), addrBind.ToString().c_str());
        else
