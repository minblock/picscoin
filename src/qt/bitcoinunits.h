...
/** Picscoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class PicscoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PicscoinUnits(QObject *parent);

    /** Picscoin units.
      @note Source: https://en.picscoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef PicscoinUnits::Unit PicscoinUnit;
