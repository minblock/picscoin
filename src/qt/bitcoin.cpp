...
int main(int argc, char *argv[])
{
    ...
    if (!boost::filesystem::is_directory(GetDataDir(false)))
    {
        ...
        QMessageBox::critical(0, "Picscoin",
    ...
    QApplication::setOrganizationName("Picscoin");
    QApplication::setOrganizationDomain("picscoin.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("Picscoin-Qt-testnet");
    else
        QApplication::setApplicationName("Picscoin-Qt");
