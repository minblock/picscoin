...
//! Entry point for PicscoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &PicscoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for PicscoinGUI tests.
void AppTests::guiTests(PicscoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &PicscoinGUI::consoleShown, this, &AppTests::consoleTests);
