    ...
    mapper(nullptr)
{
    ...
    ui->picscoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->picscoinAtStartup);
    ...
    ui->picscoinAtStartup->setToolTip(ui->picscoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->picscoinAtStartup->setText(ui->picscoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openPicscoinConfButton->setToolTip(ui->openPicscoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new PicscoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->picscoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openPicscoinConfButton_clicked()
{
