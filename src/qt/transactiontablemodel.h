...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, PicscoinUnits::SeparatorStyle separators=PicscoinUnits::separatorStandard) const;
