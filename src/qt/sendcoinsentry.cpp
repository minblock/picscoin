    ...
    platformStyle(_platformStyle)
{
    ...
    // normal picscoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying picscoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &PicscoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
