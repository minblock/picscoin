...
enum WalletFlags : uint64_t {
    ...
    //! picscoin from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The Picscoin Core wallet was originally a collection of unrelated private
...
public:
     ...
     * on this picscoin node, and set to 0 for transactions that were created
