...
uint256 hashGenesisBlock("0xd184eb9c9544e569d3f3e80de802c2a353e1ff2224b96e793f83d20c89843110");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x8a401af4a7d371e5102d9d0731f9c4e43e1b71dbb24ea5607f000f15d3f58a0a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1541047793;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084543996;

        if (fTestNet)
        {
            block.nTime    = 1541047765;
            block.nNonce   = 386977885;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x2402e13c93957aa10bed945886f3cfbe12749bb8886492db16560c8419a42c9d"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Picscoin: increase each by adding 2 to bitcoin's value.
