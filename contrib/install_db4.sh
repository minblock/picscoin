...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the picscoin repository."
  exit 1
fi
...
# See https://github.com/picscoin/picscoin/issues/16064
...
echo 'When compiling picscoind, run `./configure` in the following way:'
echo
