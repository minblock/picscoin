...
(define* (make-picscoin-cross-toolchain target
                                  #:key
...
desirable for building Picscoin Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-picscoin-cross-toolchain "i686-linux-gnu")
       (make-picscoin-cross-toolchain "x86_64-linux-gnu")
       (make-picscoin-cross-toolchain "aarch64-linux-gnu")
       (make-picscoin-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-picscoin-cross-toolchain "riscv64-linux-gnu"
