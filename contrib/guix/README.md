# Bootstrappable Picscoin Core Builds

This directory contains the files necessary to perform bootstrappable Picscoin
Core builds.
...
- 24GB of free disk space on the partition that the Picscoin Core git repository
  resides in
...
For a Picscoin Core depends development environment, simply invoke
...
From the top of a clean Picscoin Core repository:
...
To use dongcarl's substitute server for Picscoin Core builds after having
