...
By default, picscoind will dump mempool on shutdown and
...
class MempoolPersistTest(PicscoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent picscoind from writing mempool.dat to disk. Verify that `savemempool` fails")
