...
class P2PPermissionsTests(PicscoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].picscoinconf, encoding="utf8") as f:
            newText=f.read().replace(old, new)
        with open(self.nodes[nodeid].picscoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
