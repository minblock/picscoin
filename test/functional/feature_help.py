...
"""Verify that starting picscoin with -h works as expected."""

from test_framework.test_framework import PicscoinTestFramework
from test_framework.util import assert_equal

class HelpTest(PicscoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start picscoin with -h for help text")
        ...
        self.log.info("Start picscoin with -version for version information")
        ...
        self.log.info("Start picscoind with -fakearg to make sure it does not start")
