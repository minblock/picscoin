...
This document provides guidelines for internationalization of the Picscoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `picscoin_en.ts` remains unchanged.
