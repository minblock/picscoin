*After branching off for a major version release of Picscoin Core, use this
...
https://github.com/picscoin-core/picscoin-devwiki/wiki/
...
Picscoin Core version *version* is now available from:

  <https://picscoins.org/bin/picscoin-core-*version*/>
...
Upgrading directly from a version of Picscoin Core that has reached its EOL is
possible, but might take some time if the datadir needs to be migrated.  Old
wallet versions of Picscoin Core are generally supported.

Compatibility
==============

Picscoin Core is supported and extensively tested on operating systems using
the Linux kernel, macOS 10.10+, and Windows 7 and newer. It is not recommended
to use Picscoin Core on unsupported systems.
...
- When fetching a transaction announced by multiple peers, previous versions of
  Picscoin Core would sequentially attempt to download the transaction from each
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/picscoin/picscoin/).
