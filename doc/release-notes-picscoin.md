Picscoin Core version *0.15.1* is now available from:
  ...
  <https://download.picscoin.org/picscoin-0.15.1/>
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 bitmaps per kB (0.00001 PIC). This is to prepare for dropping the minimum transaction fee to 0.1 bitmaps per kB (0.0001 PIC) in the next release.
