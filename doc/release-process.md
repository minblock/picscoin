...
### Picscoin maintainers/release engineers, update version in sources
...
### Build and sign Picscoin Core for Linux, Windows, and OS X:

    pushd ./gitian-builder
    ./bin/gbuild --memory 3000 --commit picscoin=v${VERSION} ../picscoin/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --memory 3000 --commit picscoin=v${VERSION} ../picscoin/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --memory 3000 --commit picscoin=v${VERSION} ../picscoin/contrib/gitian-descriptors/gitian-osx.yml
...
Build output expected:
  ...
  4. OS X unsigned installer and dist tarball (`picscoin-${VERSION}-osx-unsigned.dmg`, `picscoin-${VERSION}-osx64.tar.gz`)
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import picscoin/contrib/gitian-keys/*.pgp
    gpg --refresh-keys
