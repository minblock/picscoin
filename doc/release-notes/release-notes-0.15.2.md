Picscoin Core version *0.15.2* is now available from:

  <https://picscoins.org/bin/picscoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in picscoin-tx (TheBlueMatt)
