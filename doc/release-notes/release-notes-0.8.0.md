Picscoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/picscoin/files/Picscoin/picscoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Picscoin
...
New/changed settings (command-line or picscoin.conf file)
--------------------------------------------------------
