Picscoin Core version *0.14.3* is now available from:

  <https://picscoin.org/bin/picscoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/picscoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
