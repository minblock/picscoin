Picscoin Core version 0.16.3 is now available from:
  ...
  <https://picscoins.org/bin/picscoin-core-0.16.3/>
...
been discovered in Picscoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` picscoinconsensus: invalid flags error should be set to `picscoinconsensus_err` (afk11)
