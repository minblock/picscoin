Picscoin Core version 0.9.4 is now available from:

  https://picscoin.org/bin/0.9.4/
...
this update is incompatible with the Picscoin system and could lead to consensus
forks.

Picscoin Core released binaries from https://picscoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~picscoin/+archive/ubuntu/picscoin
- A third-party or self-compiled Picscoin Core

upgrade to Picscoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
