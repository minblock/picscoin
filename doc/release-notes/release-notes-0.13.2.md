Picscoin Core version 0.13.2 is now available from:
  ...
  <https://picscoin.org/bin/picscoin-core-0.13.2/>
...
- #8908 `4a974b2` Update picscoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow picscoin-tx to create v2 transactions (btcdrak)
