Picscoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/picscoin/files/Picscoin/picscoin-0.5.4/
...
http://gitorious.org/picscoin/picscoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Picscoin-Qt notifications under Growl 1.3.
Increase required age of Picscoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPicscoin properly when installing Picscoin-Qt over it. (Windows)
