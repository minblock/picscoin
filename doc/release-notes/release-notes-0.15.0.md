Picscoin Core version *0.15.0* is now available from:
  ...
  <https://picscoin.org/bin/picscoin-core-0.15.0/>
...
Picscoin Core has supported creating opt-in replace-by-fee (RBF) transactions
...
transaction with a higher-fee transaction are both supported in the GUI (See [PR 9592](https://github.com/picscoin/picscoin/pull/9592)).
