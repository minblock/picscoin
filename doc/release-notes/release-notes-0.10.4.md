Picscoin Core version 0.10.4 is now available from:

  <https://picscoin.org/bin/picscoin-core-0.10.4/>
...
- #6953 `43c2789` Split picscoin-tx into its own package
- #6953 `dfe0d4d` Include picscoin-tx binary on Debian/Ubuntu
