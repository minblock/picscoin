...
1. Clone the Picscoin Core source code:
    ```shell
    git clone https://github.com/picscoin/picscoin
    cd picscoin
    ```
...
## `disable-wallet` mode
When the intention is to run only a P2P node without a wallet, Picscoin Core may be
...
```shell
mkdir -p "/Users/${USER}/Library/Application Support/Picscoin"

touch "/Users/${USER}/Library/Application Support/Picscoin/picscoin.conf"

chmod 600 "/Users/${USER}/Library/Application Support/Picscoin/picscoin.conf"
```

The first time you run picscoind, it will start downloading the blockchain. This process could
...
processors only.
* Building with downloaded Qt binaries is not officially supported. See the notes in [#7714](https://github.com/picscoin/picscoin/issues/7714).
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  script that is also included there. Detached signatures are available from this [repository](https://github.com/picscoin-core/picscoin-detached-sigs).
