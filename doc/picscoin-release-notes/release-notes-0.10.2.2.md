Picscoin Core version 0.10.2.2 is now available from:

  <https://download.picsco.in/picscoin-0.10.2.2/>
...
- Testnet TCP port 11337 (instead of 11337)
- Testnet RPC TCP port 11335 (instead of 18332)
...
- Picscoin Core v0.10.2.2 is protocol version 70003 (instead of 70002)
...
Notable changes since Picscoin v0.8
===================================

- The Block data and indexes of v0.10 are incompatible with v0.8 clients.  You can upgrade from v0.8 but you downgrading is not possible.  For this reason you may want to make a backup copy of your Data Directory.
- picscoind no longer sends RPC commands.  You must use the separate picscoin-cli command line utility.
