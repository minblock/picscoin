...
Testing changes
----------------
- The default regtest JSON-RPC port has been changed to 25566 to avoid conflict with testnet's default of 11336.
...
- #482 `5c8e26d` Picscoin: Basic changes for v0.16 release (thrasher-)
