...
[good first issue](https://github.com/picscoin/picscoin/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list.

Communication Channels
----------------------

Most communication about Picscoin Core development happens on IRC, in the
#picscoin-core-dev channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/picscoin-core-dev/](http://www.erisian.com.au/picscoin-core-dev/)
and [http://gnusha.org/picscoin-core-dev/](http://gnusha.org/picscoin-core-dev/).

Discussion about code base improvements happens in GitHub issues and on pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/picscoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - *Test* for changes to the picscoin unit tests or QA tests
...
[Translation Process](https://github.com/picscoin/picscoin/blob/master/doc/translation_process.md)
