...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the picscoin unit tests or QA tests
...
The following applies to code changes to the Picscoin Core project, and is not to be confused with overall Picscoin
...
Copyright
---------
Copyright 2018 The Picscoin Core Developers
