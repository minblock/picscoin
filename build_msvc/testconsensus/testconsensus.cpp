...
// picscoin includes.
#include <..\src\script\picscoinconsensus.h>
...
int main()
{
    std::cout << "picscoinconsensus version: " << picscoinconsensus_version() << std::endl;
    ...
    auto op0Result = picscoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, picscoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
